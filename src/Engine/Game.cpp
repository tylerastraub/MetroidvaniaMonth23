        ...
        if(_window == nullptr)
        {
            ...
            if(_renderer == nullptr) {
                ...
                if(TTF_Init() == -1) {
                    ...
                    // // io.Fonts->AddFontFromFileTTF("res/font/ProggyClean.ttf", 8.f, NULL, NULL);
                    // ImGui::StyleColorsDark();
                    // io.Fonts->AddFontDefault();
                    // io.Fonts->Build();
                    // if(ImGui_ImplSDL2_InitForSDLRenderer(_window, _renderer) == false) {
                    //     std::cout << "ImGui could not be initialized!" << std::endl;
                    // }
                    // else {
...
bool Game::loadResources() {
    ...
    if(!SpritesheetRegistry::addSpritesheet(_renderer, SpritesheetID::PLAYER, "res/spritesheet/player.png", 24, 32)) return false;
